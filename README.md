...
This project extends the **Retail Campaign Automation** system by introducing an AI-powered **Retail Decision Intelligence** layer. It combines **RAG**, **AI agents**, **tool calling**, and a **deterministic decision engine** to analyze store performance, retrieve business knowledge, and generate explainable, evidence-based recommendations for retail decision-making while keeping humans in control of final approvals.
